<?php
/**
 * This is a copy of the block-supports/layout.php WordPress Core File
 *
 * Notes added for clarification on what the functions are doing and what's being
 * called and referenced elsewhere in WP / Gutenberg.
 *
 * @url https://github.com/WordPress/WordPress/blob/28a12c8bcefecb2a4b040f63c9ce6574abf473eb/wp-includes/block-supports/layout.php#L45
 */
/**
...
function wp_register_layout_support( $block_type ) {
    // When overriding these functions, likely all these need to be added since they are private functions in WP.
...
function wp_get_layout_style( $selector, $layout, $has_block_gap_support = false, $gap_value = null ) {
    ...
    $style = '';
    /**
     * $layout_type is a reference to how Gutenberg blocks are rendering the 'type'
     * property: e.g. 'flex' - plans to add things like 'grid' are coming.
     *
     * These are primitive layout components.
     *
